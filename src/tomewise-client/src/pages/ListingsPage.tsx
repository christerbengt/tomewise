...
const ListingsPage = () => {
  ...
  if (isLoading) return <div className="loading">Loading listings...</div>;
                  ...
                  <div key={listing.id} className="listing-card">
                    <div className="listing-info">
                      ...
                      <span className="listing-meta">
                        {platformLabels[listing.platform]} · Asking {listing.askingPrice} SEK
                      </span>
                      {listing.description && (
                ...
                {closed.map((listing) => (
                  <div key={listing.id} className="listing-card listing-card--closed">
                    <div className="listing-info">
                      <span className="listing-title">{listing.bookTitle}</span>
                      <span className="listing-meta">
                        {statusLabels[listing.status]} · {platformLabels[listing.platform]}
                        {listing.soldPrice && ` · Sold for ${listing.soldPrice} SEK`}
                      </span>
                    </div>
                  </div>
                ))}
